...
class AMQP::Client
  ...
  class Channel
    ...
    def basic_publish(io : IO, exchange : String, routing_key : String, opts = {} of String => AMQ::Protocol::Field)
    ...
    def basic_nack(delivery_tag : UInt64, multiple = false, requeue = false) : Nil
